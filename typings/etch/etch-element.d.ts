...
type HTMLElementTagNameMapWithOptionals = {
  [K in keyof HTMLElementTagNameMap]: Partial<Omit<HTMLElementTagNameMap[K], 'style'>> & EtchExtraProps
};

type ElementClassConstructor<T extends JSX.ElementClass> = new (props: Props, children: EtchJSXElement[]) => T;
